...
public class AmbienceManager : MonoBehaviour
{
    ...
    IEnumerator FadeToNewMusic(AudioClip newClip)
    {
        ...
        while (time < fadeDuration)
        {
            ...
            currentSource.volume = (1f - t) * AudioSettingsManager.Instance.effectsVol;
            nextSource.volume = t * AudioSettingsManager.Instance.effectsVol;
            time += Time.deltaTime;
            yield return null;
        }
        ...
        nextSource.volume = AudioSettingsManager.Instance.effectsVol;
    ...
    IEnumerator FadeOutAndStop()
    {
        ...
        {
            float t = time / fadeDuration;
            audioSourceA.volume = Mathf.Lerp(startVolumeA, 0f, t) * AudioSettingsManager.Instance.effectsVol;
            audioSourceB.volume = Mathf.Lerp(startVolumeB, 0f, t) * AudioSettingsManager.Instance.effectsVol;
            time += Time.deltaTime;
            yield return null;
        }
